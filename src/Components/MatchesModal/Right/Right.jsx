...
function Right({ 
    ...
    let mainBtnStyles = `h-10 w-28 flex justify-center items-center rounded-lg text-white ${isMatched ? 'group-hover:font-semibold' : 'hover:font-semibold'} bg-gradient-to-r ${displayRequestSentTo ? buttonColor.pendingProfile : buttonColor.matchedOrRecievedProfile} cursor-pointer`;
