...
function ProfileDropDown({ skills, fetchSentRequests, requests, setUser, isShown, setIsShown, setIsSettings }) {  
    return(
        <>
            {isShown && (
                <div className={`absolute top-full right-0 w-max h-fit py-5 bg-stone-950 text-xl shadow-xl shadow-black`}>
                    ...
                    <ProfileDropDownOption setIsShown={setIsShown} text="Requests" fetchSentRequests={fetchSentRequests} requests={requests} />
